...
// add horizontal and vertical platform (using addblock)
...
int main()
{
    ...
    float spike8size = 40;
    // for spikes rectangle
    Vector2 spike8position = {7.97 * blocksize, 15.6 * blocksize};
    ...
    float spike9size = 40;
    // for spikes rectangle
    Vector2 spike9position = {7.5 * blocksize, 15.6 * blocksize};
